    ...
    async def bust_kneecaps(self, context: commands.Context):
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get('https://cdn.discordapp.com/attachments/514221002117480451/1232873953610039347/Rian_bustin_kneecaps_Made_with_FlexClip1.gif?ex=674288d8&is=67413758&hm=8a79893799d085879905fefa88d7e68bffb5b9cc34b93b013831e35b6548e790&') as resp:
                    if resp.status != 200:
